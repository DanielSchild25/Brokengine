...
//#include "Brokengine/Core/Input.h"

#include "Brokengine/Events/ApplicationEvent.h"
#include "Brokengine/Events/MouseEvent.h"
#include "Brokengine/Events/KeyEvent.h"
//
//#include "Brokengine/Renderer/Renderer.h"
//
...
namespace Brokengine {
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		{
			//BE_PROFILE_SCOPE("glfwCreateWindow");
//#if defined(BE_DEBUG)
